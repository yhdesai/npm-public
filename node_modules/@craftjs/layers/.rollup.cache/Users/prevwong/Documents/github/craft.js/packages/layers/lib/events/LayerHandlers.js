            ...
            layer: (el) => {
                ...
                const unbindDragOver = this.addCraftEventListener(el, 'dragover', (e) => {
                    ...
                    if (currentCanvasHovered && indicator) {
                        const heading = this.getLayer(canvasNode.id).headingDom.getBoundingClientRect();
                        if (e.clientY > heading.top + 10 &&
                            e.clientY < heading.bottom - 10) {
                            const currNode = canvasNode.getChildAtIndex(canvasNode.getChildNodes().length);
                            if (!currNode) {
                                return;
                            }
                ...
                const unbindDragEnter = this.addCraftEventListener(el, 'dragenter', (e) => {
                    ...
                    if (indicatorInfo) {
                        ...
                        const parentHeadingInfo = this.getLayer(parentNode.id).headingDom.getBoundingClientRect();
            ...
            drag: (el) => {
                ...
                const unbindDragEnd = this.addCraftEventListener(el, 'dragend', (e) => {
                    ...
                    if (events.indicator && !events.indicator.error) {
                        ...
                        editorStore.actions.move(LayerHandlers.draggedElement, parent, index + (where === 'after' ? 1 : 0));
                    }
