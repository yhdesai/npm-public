    ...
    return (React.createElement(Fragment, null,
        indicator &&
            React.createElement(RenderIndicator, {
                style: {
                    ...movePlaceholder(indicator.placement, getDOMInfo(query.node(indicator.placement.parent).dom), indicator.placement.currentNode &&
                        getDOMInfo(query.node(indicator.placement.currentNode).dom), indicatorOptions.thickness),
