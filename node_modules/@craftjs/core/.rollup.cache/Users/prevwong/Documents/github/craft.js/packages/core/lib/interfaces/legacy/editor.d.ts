import { FreshNode, LegacyNodeQuery, SerializedNode, SerializedNodes } from './nodes';
...
export interface LegacyEditorQuery {
    ...
    serialize(): string;
    parseSerializedNode(serializedNode: SerializedNode): any;
    parseFreshNode(freshNode: FreshNode): any;
}
