...
export const createNode = (partialNode = {}) => ({
...
export const createNodeWithResolverConfig = (partialNode, resolver) => {
...
export const adaptLegacyNode = (node, resolver) => {
    if (node.data) {
        const { id, data: { type: componentType, ...legacyNodeData }, } = node;
